...
<p align="center">
    <img width="35%" src="https://github.com/nesi/intro-python/blob/main/data/login.png"/> 
    <img width="24%" height="50%" src="https://github.com/nesi/intro-python/blob/main/data/appselection.png"/> 
</p>
